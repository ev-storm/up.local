...
document.addEventListener("DOMContentLoaded", function() {
	...
	// Функция для активации overlay и соответствующей картинки
	miniImages.forEach((img, index) => {
			img.addEventListener('click', () => {
					// Показываем cover-sert и активируем соответствующее изображение
	...
	// Скрытие overlay при клике в любом месте, кроме save-img и активного изображения
	coverSert.addEventListener('click', (event) => {
			...
			// Проверка, чтобы клик был произведён не по save-img и не по активному изображению
