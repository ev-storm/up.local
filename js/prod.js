...
// 		 // Функция для изменения изображения на основе выбранного сегмента
// 		 function changeSlide(segment) {
// 			const slideImage = document.querySelector('.segment-slide img');

// 				// Проверяем, какой сегмент был нажат
// 				if (segment === 'Фармацевтика') {
// 						slideImage.src = '/assets/img/farma-slide.png';
// 				} else if (segment === 'Стоматология') {
// 						slideImage.src = '/assets/img/stom-slide.jpg';
// 				}
// 			}
...
//     // // Добавляем обработчики событий для кнопок сегментов
//     // document.querySelector('.i-farma').addEventListener('click', function() {
//     //     changeSlide('Фармацевтика');
//     // });

//     // document.querySelector('.i-cosm').addEventListener('click', function() {
//     //     changeSlide('Стоматология');
//     // });
